...
def parse_args(extra_args_provider=None, defaults={},
    ...
    # Include Project Pactum configuration arugments
    import project_pactum.training
    parser = project_pactum.training.add_arguments(parser)
    ...
    if 'PROJECT_PACTUM_NUM_STAGES' in os.environ:
        args.pipe_parallel_size = int(os.environ['PROJECT_PACTUM_NUM_STAGES'])
